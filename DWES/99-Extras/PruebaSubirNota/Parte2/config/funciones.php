...
function renderContentTable(){
    ...
    $sql = "select * from rebajas_ivan order by rebaja desc";
        ...
        if($sentencia -> rowCount() != 0){
            for ($i=0; $i < $sentencia -> rowCount(); $i++) { 
                ...
                echo "<tr>";
                    ...
                    echo "<td>". PrecioRebaja($prenda -> precio, $prenda -> rebaja) ." $</td>";
                    echo "<td>". calRebaja($prenda -> precio, $prenda -> rebaja) . " $</td>";
...
function PrecioRebaja($precio, $rebaja){
    return $precio * ($rebaja/100);
}
// Funcion para calcular el precio final de la prenda
function calRebaja ($precio, $rebaja){
    return $precio - PrecioRebaja($precio,$rebaja);
}
...
function renderFormMod($id){
    ...
    try{
        ...
        if($stmt -> rowCount() != 0){
            ...
            echo "<input type='text' name='prenda' value='". $prenda -> prenda ."' readonly><br>";
            echo "<label>Precio de la prenda</label><br>";
            echo "<input type='number' name='precio' value='". $prenda -> precio ."' readonly><br>";
            ...
            echo "<img src='data:image/png;base64, ".base64_encode($prenda -> foto)."' width = '50px' height='50px'><br>";
